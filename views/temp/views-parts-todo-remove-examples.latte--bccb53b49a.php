...
/** source: /Users/chrislindgren/Local Sites/sigdocconference/app/public/wp-content/themes/theme-sigcon/views/parts/todo-remove-examples.latte */
final class Templatebccb53b49a extends Latte\Runtime\Template
{
	public const Blocks = [
...
';
		$test_tabs = [['anchor' => 'Tab 1', 'content' => ['title' => 'Tab Panel 1 Title', 'text' => 'Tab Panel 1 text that is very long']], ['anchor' => 'Tab 2', 'content' => ['text' => 'Tab Panel 2 text that is very long']], ['anchor' => 'Tab 3', 'content' => ['title' => 'Tab Panel 3 Title', 'text' => 'Tab Panel 3 text that is very long']]] /* line 146 */;
		echo "\n";
...
';
		...
		try {
			$this->createTemplate(tr_part('_accordion'), ['items' => $test_acc_items, 'initially_open_item' => 0, 'collapse_siblings' => true], "embed")->renderToContentType('html') /* line 213 */;
		} finally {
			$this->leaveBlockLayer();
		}
		echo '				</div>
...
';
		$posts_query = new WP_Query(['post_type' => 'post', 'posts_per_page' => 6, 'orderby' => 'DESC']) /* line 331 */;
		echo "\n";
		$this->enterBlockLayer(6, get_defined_vars()) /* line 339 */;
		try {
			$this->createTemplate(tr_part('_slider'), ['class' => 'slider--test', 'slides' => $posts_query], "embed")->renderToContentType('html') /* line 339 */;
		} finally {
			$this->leaveBlockLayer();
		}
		echo '
...
';
		...
		try {
			$this->createTemplate(tr_part('_slider'), ['class' => 'slider--test2', 'slides' => $test_slides], "embed")->renderToContentType('html') /* line 362 */;
		} finally {
			$this->leaveBlockLayer();
		}
		echo '	</div>
...
';
		$img_1_data_string = 'people/photo-1517299151253-d0449b733f57.jpg' /* line 608 */;
		echo '					';
		echo LR\Filters::escapeHtmlText(tr_get_media($img_1_data_string)) /* line 609 */;
		echo '
...
';
	...
	public function blockTab_panel(array $ʟ_args): void
	{
		...
		if ($tp_key === 0) /* line 177 */ {
			...
			try {
				$this->createTemplate(tr_part('_accordion'), ['items' => $test_acc_items, 'initially_open_item' => 0, 'collapse_siblings' => true], "embed")->renderToContentType('html') /* line 178 */;
			} finally {
				$this->leaveBlockLayer();
			}
		} else /* line 199 */ {
