...
/** source: /Users/chrislindgren/Local Sites/sigdocconference/app/public/wp-content/themes/theme-sigcon/views/parts/_collapsibles.latte */
final class Templatee8a21b7933 extends Latte\Runtime\Template
{
	public const Blocks = [
...
';
		...
		try {
			$this->createTemplate(tr_part('_accordion'), ['items' => $test_acc_items, 'initially_open_item' => 0, 'collapse_siblings' => true], "embed")->renderToContentType('html') /* line 26 */;
		} finally {
...
';
		...
		try {
			$this->createTemplate(tr_part('_accordion'), ['items' => $test_acc_items, 'initially_open_item' => 0, 'duration' => 700, 'collapse_siblings' => true, 'easing' => 'cubic-bezier(1,-0.06, 0, 1.56)'], "embed")->renderToContentType('html') /* line 50 */;
		} finally {
			$this->leaveBlockLayer();
		}
		echo '  </div>
...
';
		...
		try {
			$this->createTemplate(tr_part('_accordion'), ['items' => $test_acc_items, 'initially_open_item' => 2], "embed")->renderToContentType('html') /* line 76 */;
		} finally {
			$this->leaveBlockLayer();
		}
		echo '  </div>
...
';
		...
		try {
			$this->createTemplate(tr_part('_accordion'), ['items' => $test_acc_items, 'initially_open_item' => 0, 'collapse_siblings' => true], "embed")->renderToContentType('html') /* line 111 */;
		} finally {
			$this->leaveBlockLayer();
		}
		echo '
...
';
		$dummy_dd_options = [['value' => 'none', 'label' => 'Select Option'], ['value' => 'option-1', 'label' => 'Option 1'], ['value' => 'option-2', 'label' => 'Option 2'], ['value' => 'option-3', 'label' => 'Option 3'], ['value' => 'option-4', 'label' => 'Option 4']] /* line 180 */;
		echo '
...
';
		...
		try {
			$this->createTemplate(tr_part('_collapsible'), ['on_hover' => true, 'is_absolute' => true], "embed")->renderToContentType('html') /* line 259 */;
		} finally {
			$this->leaveBlockLayer();
		}
		echo '  </div>
...
';
		$this->createTemplate(tr_part('dropdown-select'), ['options' => $dummy_dd_options, 'class' => 'custom-class', 'duration' => 200, 'close_outside' => true, 'default_selected_key' => 3] + $this->params, 'include')->renderToContentType('html') /* line 294 */;
		echo '
  </div>
  <div class="col">
    <h5>Hover</h5>
';
		$this->createTemplate(tr_part('dropdown-select'), ['options' => $dummy_dd_options, 'on_hover' => true, 'default_selected_key' => 0] + $this->params, 'include')->renderToContentType('html') /* line 306 */;
		echo '  </div>
  <div class="col">
    <h5>Hover - absolute</h5>
';
		$this->createTemplate(tr_part('dropdown-select'), ['options' => $dummy_dd_options, 'is_absolute' => true, 'on_hover' => true, 'default_selected_key' => 2] + $this->params, 'include')->renderToContentType('html') /* line 315 */;
		echo '  </div>
</div>
...
';
		$custom_keyframes = [['opacity' => 0, 'transform' => 'translateY(-10px)', 'pointer-events' => 'none'], ['transform' => 'translateY(10px)', 'offset' => 0.9], ['opacity' => '1', 'transform' => 'translateY(0)', 'pointer-events' => 'all']] /* line 334 */;
		echo '
...
';
		...
		try {
			$this->createTemplate(tr_part('_collapsible'), ['on_hover' => true, 'is_absolute' => true, 'duration' => 500, 'easing' => 'cubic-bezier(1,-0.06, 0, 1.56)'], "embed")->renderToContentType('html') /* line 358 */;
		} finally {
			$this->leaveBlockLayer();
		}
		echo '  </div>
...
';
		...
		try {
			$this->createTemplate(tr_part('_collapsible'), ['on_hover' => true, 'is_absolute' => true, 'aria_label' => 'Toggle Hover Dropdown', 'custom_keyframes' => $custom_keyframes], "embed")->renderToContentType('html') /* line 384 */;
		} finally {
			$this->leaveBlockLayer();
		}
		echo '  </div>
...
';
		...
		try {
			$this->createTemplate(tr_part('_collapsible'), ['on_hover' => true, 'is_absolute' => true, 'aria_label' => 'Toggle Hover Dropdown', 'custom_keyframes' => $custom_keyframes, 'duration' => 600, 'easing' => 'cubic-bezier(1,-0.06, 0, 1.56)'], "embed")->renderToContentType('html') /* line 410 */;
		} finally {
			$this->leaveBlockLayer();
		}
		echo '  </div>
...
';
	...
	public function blockAcc_content4(array $ʟ_args): void
	{
		...
		if ($index === 0) /* line 135 */ {
			...
			try {
				$this->createTemplate(tr_part('_accordion'), ['items' => $test_acc_items, 'collapse_siblings' => true, 'easing' => 'cubic-bezier(1,-0.06, 0, 1.56)'], "embed")->renderToContentType('html') /* line 136 */;
			} finally {
				$this->leaveBlockLayer();
			}
			echo "\n";
