...
/** source: /Users/calindgr/Documents/Local Sites/sigdocconference/app/public/wp-content/themes/theme-sigcon/views//layout/header-schedule.latte */
final class Template806bd4c705 extends Latte\Runtime\Template
{
...
';
	...
	<header class="bg-logo-container" role="banner" aria-labelledby="main-title">
		...
		<div class="absolute-img">
			...
			<!-- Logo -->
			<div class="logo">
				<svg id="sigdoc-23-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 222.47 226.03">
					<g id="Calque_2">
						<g id="color">
							<path class="cls-11" d="m182.94,193.53l-2.9-3.6c1.2-1,2.6-1.9,4.1-2.9,3-2,6.2-4.1,7.5-6.7l4.2,2.1c-1.9,3.7-5.7,6.3-9.1,8.5-1.4.9-2.7,1.8-3.8,2.6Z"></path>
							<path class="cls-12" d="m151.54,214.03l-1.8-4.2c12.9-5.4,22.3-13,33.2-21.8l1.3-1.1,2.8,3.5-1.3,1.1c-11.1,9-20.7,16.8-34.2,22.5Z"></path>
							<path class="cls-13" d="m156.74,206.03l-3.3-7.8c12.6-5.3,21.9-12.8,32.7-21.5l1.3-1.1,5.3,6.6-1.3,1.1c-10.8,8.7-21,16.9-34.7,22.7Z"></path>
							<path class="cls-2" d="m108.14,225.53c-9.8,0-19.6-1.1-29.1-3.1l2.5-11.1c25.7,5.6,52.7,3,78-7.7l4.4,10.5c-17.7,7.4-36.6,11.3-55.8,11.4Z"></path>
							<path class="cls-17" d="m107.84,217.03c-9.7,0-19.4-1-28.8-3.1l1.8-8.3c26,5.7,53.3,3,78.9-7.8l3.3,7.8c-17.5,7.4-36.3,11.3-55.2,11.4Z"></path>
							<path class="cls-40" d="m94.14,225.23c-33.7-7.4-62.4-29.6-78.7-60.9S-2.86,96.73,10.34,64.83l7.9,3.2c-12.2,29.5-10.5,63.2,4.8,92.3s41.8,49.7,73,56.5l-1.9,8.4Z"></path>
							<path class="cls-2" d="m102.64,221.13c-33.1-7.2-61.3-29.1-77.4-59.9S7.34,94.83,20.24,63.43l7.9,3.2c-12,29-10.3,62,4.7,90.6s41.1,48.8,71.7,55.5l-1.9,8.4Z"></path>
							<path class="cls-40" d="m2.84,75.43l-1.6-.7C15.74,39.63,45.64,14.03,83.34,4.43c37.7-9.6,76.1-1.4,105.5,22.5l-1.1,1.4C158.74,4.83,120.84-3.17,83.74,6.23S17.14,40.83,2.84,75.43Z"></path>
							<path class="cls-37" d="m172.04,82.83l-2.2-5.6-.7-1.8h2q.9,0,2.3,3.6,1.1,2.9,1.2,3l-2.6.8Z"></path>
							<path class="cls-36" d="m167.04,81.43c-7.87-10.02-17.81-18.2-29.14-24l1.07-2.08c11.68,5.91,21.8,14.35,29.84,24.63l-1.77,1.44Z"></path>
							<path class="cls-16" d="m196.64,82.33c-4.6-11.4-11.6-21.6-20.6-30l5.8-6.2c9.9,9.2,17.6,20.5,22.7,33l-7.9,3.2Z"></path>
							<path class="cls-20" d="m110.64,128.83v-2.5c7.7-.3,13.6-6.8,13.3-14.4-.2-3.9-2-7.6-5-10.1l1.5-2c7,5.8,8,16.1,2.2,23.1-2.9,3.5-7.2,5.7-12,5.9h0Z"></path>
							<path class="cls-25" d="m110.44,129.03c-9.2-.2-16.5-7.8-16.3-16.9.1-4.8,2.3-9.3,5.9-12.4l1.8,2.3c-5.8,4.9-6.5,13.5-1.6,19.3,2.5,3,6.2,4.8,10.1,4.9h.3v2.9h-.2v-.1Z"></path>
							<path class="cls-3" d="m109.44,108.63v-1.7c0-.9,1.3-1.4,1.6-1.4h3.4l-5,3.1Z"></path>
							<path class="cls-25" d="m116.34,118.53l-.8-2.1c3.3-1.3,4-3.5,4.2-4.8.2-1.8-.7-3.6-2.2-4.6-1.6-1-3.8-.9-6,.5l-1.2-1.9c2.9-1.8,6-2,8.3-.5s3.5,4.1,3.3,6.8c-.3,2.9-2.3,5.3-5.6,6.6Z"></path>
							<path class="cls-18" d="m113.34,119.13c-2.6,0-5-1.5-6.1-3.9-1.7-3.6-.4-7.8,3.1-9.8l1.2,2c-2.4,1.3-3.4,4.2-2.2,6.7.8,1.7,3,3.3,6.1,2.1l.8,2.2c-.8.5-1.8.7-2.9.7Z"></path>
					...
					<path class="cls-35" d="m167.84,89.13c3.3,4.9,5.9,10.2,7.8,15.8,8.2,24.1,1.8,49.4-16.5,66.1l-1.7-1.9c17.6-15.9,23.6-40.2,15.8-63.3s-27.5-38.8-51.2-40.8l.2-2.6c18.5,1.4,35.3,11.3,45.6,26.7Z"></path>
					<path class="cls-25" d="m139.03,85.38c13.9,19.7,7.5,45.8-15.1,62.1l-4-3.3c20.5-14.8,26.3-38.6,13.7-56.4l5.4-2.4Z"></path>
					<path class="cls-32" d="m146.16,84.65l4.96-4.13c13.34,16.35,15.62,38.75,5.87,58.56s-28.97,32.2-50.3,32.22l.13-6.4c18.89-.03,35.94-10.96,44.56-28.57,8.62-17.61,6.52-37.28-5.23-51.67Z"></path>
					<path class="cls-29" d="m103.75,133.04l-.5,3c10.92,1.82,21.54-2.31,27.76-10.86,6.22-8.55,6.55-19.34.78-28.2l-2.83,1.51c5.1,7.85,4.83,17.41-.71,24.98s-14.9,11.17-24.51,9.56Z"></path>
				</svg>
			</div>
	...
	<main class="main-content-no-subtitle ';
			...
			.schedule__container {
				...
				.form-group {
					...
					&> .form-control {
						...
						&:focus {
							border-color: var(--secondaryShade5);
							outline: none;
							box-shadow: none;
						}
					}
		...
		<article id="schedule__container" class="schedule__container">
			<form role="form">
				<div class="form-group">
					<input type="search" class="form-control" id="search_box" oninput="filterByName(event)">
					<label class="float-label" for="search_box">
						Search filter for presentations
					</label>
				</div>
			</form>
			
			
			<div id="toggle_all_container" style="display:none">
				<button id="button_toggle__all" class="btn btn--brand expand_more__button expand_all_button" role="button">Open All Sessions</button>
				<button id="button_close__all" class="btn btn--brand expand_more__button expand_all_button" role="button">Close All Sessions</button>
			</div>
		...
		<script>
			// Expand button
			let expandAllButton = document.getElementById(\'button_toggle__all\')
			let closeAllButton = document.getElementById(\'button_close__all\')
			let allScheduleDayContainers = document.querySelectorAll(\'div.schedule__day_container\')
			closeAllButton.setAttribute(\'style\',\'margin-left:5px;\')
			expandAllButton.addEventListener("click", (e) => {
				toggleAllVisibility(e)
			})
			closeAllButton.addEventListener("click", (e) => {
				toggleCloseAllVisibility(e)
			})

			// Append
			let toggleScheduleContainer = document.getElementById(\'toggle_all_container\')
			toggleScheduleContainer.appendChild(expandAllButton)
			toggleScheduleContainer.appendChild(closeAllButton)

			const stageDisplayer = (guideSlotContainer) => {
				let stageContainer = guideSlotContainer.parentElement.parentElement
				let totalAllStageCards = Number(stageContainer.attributes[2].nodeValue)
				let noneCardLength = stageContainer.querySelectorAll(\'.guide-slot_card[style="display: none;"]\').length

				if ( (totalAllStageCards - noneCardLength) == 0) {
					stageContainer.style.display = "none"
				}
				else if ( (totalAllStageCards - noneCardLength) > 0 ) {
					stageContainer.style.display = "grid"
				}

			}

			const roomDisplayer = (card) => {
				let guideSlotContainer = card.parentElement
				let totalAllCards = Number(guideSlotContainer.attributes[1].nodeValue)
				let noneCardLength = guideSlotContainer.querySelectorAll(\'.guide-slot_card[style="display: none;"]\').length

				if ( (totalAllCards - noneCardLength) == 0) {
					guideSlotContainer.style.display = "none"
					stageDisplayer(guideSlotContainer)
				}
			...
			const filterByName = (e) => {
				const items = document.querySelectorAll(".guide-slot_card")
				const searchTerm = e.target.value.trim().toLowerCase()

				items.forEach(item => {
					let visibilityChecker = item.checkVisibility({
						contentVisibilityAuto: true,
					})

					let glsContainer = item.parentElement.parentElement
					let currentStageCount = glsContainer.dataset.currentCount

					if(items.length == 0) {
						let noShow = document.querySelector(\'.no-result\')
					...
					// If item presentation slot card includes term, revert to show
					item.style.display = \'revert\'
					/**
						Check if stage is empty
					*/
					let roomContainer = glsContainer.childNodes
					roomContainer.forEach(guideSlots => {
						let totalCards = Number(guideSlots.attributes[1].nodeValue)
						let cards = guideSlots.querySelectorAll(\'.guide-slot_card\')

						noneCardTotal = guideSlots.querySelectorAll(\'.guide-slot_card[style="display: none;"]\').length
						if ( (totalCards-noneCardTotal) == 0 ) {
							guideSlots.style.display = "none"
						}
						else if ( (totalCards-noneCardTotal) > 0 ) {
							guideSlots.style.display = "revert"
						}
						
					})

					// Hide any schedule session containers with no results from filter
			...
			const toggleAllVisibility = (e) => {
				let className = ".schedule__stage_guide-container"
				className = className.replaceAll("\'", "")
				className = className.replaceAll("&_", "")
				className = className.replaceAll("/", "")
				const cardElements = document.querySelectorAll(className)
			...
			// Close All Button
			const toggleCloseAllVisibility = (e) => {
				let className = ".schedule__stage_guide-container"
				className = className.replaceAll("\'", "")
				className = className.replaceAll("&_", "")
				className = className.replaceAll("/", "")
