...
';
	...
	<main class="main-content-no-subtitle ';
		...
		<article id="schedule__container" class="schedule__container">
			...
			<div id="toggle_all_container">
				<button id="button_toggle__all" class="btn btn--brand expand_more__button expand_all_button" role="button" tabindex="0">Toggle All Sessions</button>
			</div>
		...
		<script>
			...
			// expandAllButton.id = "button_toggle__all"
			// expandAllButton.className = "expand_more__button btn btn--brand"
			// expandAllButton.setAttribute(\'role\',\'button\')
			// expandAllButton.setAttribute(\'tabindex\',\'0\')
			// expandAllButton.innerHTML = "Toggle All Sessions"
