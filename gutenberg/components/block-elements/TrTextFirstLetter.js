...
const TrTextEffect = ({ fieldData }) => {
  ...
  const handleTextChange = (fieldNewValue) => {
  ...
  return (
    ...
    >
      ...
      <CardBody>
        <Component value={field_object.text} onChange={handleTextChange} />
        
        {meta.feature_options.map((field, fieldIndex) => {
          return (
            <SelectControl
